...
public class JavaArtifactProcessor {
    ...
    public JavaTestSuite processArtifact(String url, String token, String destinationFolder, String zipFileName, String xmlFileName) throws IOException, JAXBException {
        ...
        JavaTestSuite javaTestSuite = parser.parse(new File(destinationFolder, xmlFileName));
